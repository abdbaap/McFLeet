...
const Page = () => {
  return (
    ...
    <span className="text-3xl font-bold bg-blue-900 text-white -skew-1 mx-4 p-4 my-4 rounded-xl"> <AnimateOnScroll> MCFleet Arcade: Your Ultimate Mini&ndash;Game Hub!</AnimateOnScroll></span>
