...
const Navbar = ({bg}) => {
  ...
  return (<nav className={`flex  py-4 z-40 justify-between relative  items-center w-[100%]  ${bg}`}>
        <Link href="#home" className="text-2xl justify-center items-center text-2xl font-extrabold gap-2 mx-2 text-white flex"><Image src={"/logo.png"} width={50} height={50} alt="logo.jpg" className="ghg"></Image><h1> MCFleet</h1></Link>
