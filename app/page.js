...
{features.map((card) => {
  ...
  <Image src={card.imageUrl} objectFit="cover" alt="mcfleet mcfleet store mcfleet website"fill="true" className=" absolute w-[100%] height-[100%] top-0 -z-10 cardimg brightness-50 "></Image>
