...
<Image src="/founder.jfif" width={400} height={400} alt="AnshuBisht Image" className="rounded-xl w-[400px]"></Image><AnimateOnScroll animationClass="opacity-0 -translate-y-10" visibleClass="opacity-100 translate-y-0">
