...
>
        <div className="bg-gray-950 border-b-2 flex w-[100%] justify-between border-b-black items-center font-bold text-xl ">Mcfleet IP: <Image src="/copy.svg" className="invert" width={50} height={50} alt="copy mcfleet mcfleet store mcfleet website mcfleetwebsite mcfleet" onClick={()=>navigator.clipboard.writeText("play.mcfleet.net")}></Image></div>
